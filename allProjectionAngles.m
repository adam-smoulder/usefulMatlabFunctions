...
% allAngles takes two matrices (A and B) assumed to be of size [D x Da] and
...
% predictive dimension for reach direction?), so I'm only intending to use
% this for when A and B are both orthonormal.
%
% Inputs: 
% - A: The first orthonormal projection matrix; columns are vectors. This
% runs is most efficient technically if A is the smaller matrix of A and B
% - B: The second orthonormal projection matrix
%
% Outputs:
